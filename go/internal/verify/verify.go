...
// Accepts a timeout and multiple directories checked in order — the command
// runs in the first directory where ralph:verify is found. Returns a failure
// if no ralph:verify command is detected.
