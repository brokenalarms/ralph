...
// Verifies that long prose lines are NOT truncated — they wrap naturally
// at the terminal width instead of being cut off with an ellipsis.
...
// Verifies that long tool call lines are NOT truncated — they wrap naturally.
