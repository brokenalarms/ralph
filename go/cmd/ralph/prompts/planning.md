...
2. Signal completion — this MUST be the very last thing you do. Ralph will kill your process immediately when it detects the signal.
   echo "planning done" > {{RALPH_DIR}}/.signal_complete
